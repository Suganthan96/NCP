...
import CreateSmartAccountButton from "@/components/CreateSmartAccount";
...
export default function Steps() {
  ...
  }, [smartAccount, permission, isConnected]);
    ...
    <div className="max-w-4xl mx-auto p-3 space-y-8">
      {step === 1 && (
        <div className="space-y-6 flex flex-col gap-6 items-center justify-center">
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
              If your account is not upgraded, the smart account won't be able to redeem the permissions.
            </p>
          </div>
          <ConnectButton />
        </div>
      ...
      {step === 2 && (
        <div className="space-y-6">
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 shadow-lg border border-gray-200 dark:border-gray-700">
            <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
              This is the smart account (ERC-4337) that redeems the
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
              ...
              subscribe to a service and this smart account is the dApp&apos;s account
              that redeems the subscription using ERC-4337.
            </p>
            <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
              Creating an ERC-4337 smart account has
              multiple benefits such as gas sponsorship, batch transactions,
              and a better user experience.
            </p>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              In this example, we create an ERC-4337 smart account with a burner private
      ...
      {step === 3 && (
        <div className="space-y-6">
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 shadow-lg border border-gray-200 dark:border-gray-700">
            <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
              Grant permissions to the smart account that was created in the previous
              step. This will prompt the user to grant the native token periodic transfer
              permissions to the smart account.
            </p>
            <p className="text-gray-700 dark:text-gray-300 mt-4 leading-relaxed">
              You can safely store the response for later redemption by the
              smart account. In this example, we will save the response in
              session state.
            </p>
          </div>
      ...
      {step === 4 && (
        <div className="space-y-6">
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 shadow-lg border border-gray-200 dark:border-gray-700">
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              The smart account submits a user operation that
